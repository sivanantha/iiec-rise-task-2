...
if pwd == confirm_pwd:
	result=cr.register(user,pwd)
	if result:
		print('<br/><br/><h3 align="center" style="color:cyan"> User created successfully !</h3>')

	else:
		print('<br/><br/><h3 align="center" style="color:cyan"> Username already exist !</h3>')
